...
const INPUT: &str = "2xjzgsjzfhzhm1
...
#[cfg(test)]
mod tests {
    const PT1_EXAMPLE_INPUT: &str = "1abc2
pqr3stu8vwx
a1b2c3d4e5f
treb7uchet";
    const PT2_EXAMPLE_INPUT: &str = "two1nine
eightwothree
abcone2threexyz
xtwone3four
4nineeightseven2
...
7pqrstsixteen";
    ...
    fn pt1_example_input() {
        assert_eq!(
            crate::d1::pt1::calculate_answer(PT1_EXAMPLE_INPUT.to_string()),
            142
        )
    }
    ...
    fn pt2_example_input() {
        assert_eq!(
            crate::d1::pt2::calculate_answer(PT2_EXAMPLE_INPUT.to_string()),
            281
        )
    }
}
